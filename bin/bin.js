...
var ASM_CONSTS = {
  72548: ($0) => { let idstr = UTF8ToString($0); let element = document.getElementById(idstr); console.log(element); return element.width; },  
 72672: ($0) => { let idstr = UTF8ToString($0); let element = document.getElementById(idstr); return element.height; }
};
