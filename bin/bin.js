...
var ASM_CONSTS = {
  86500: ($0) => { let idstr = UTF8ToString($0); let element = document.getElementById(idstr); return element.width; },  
 86602: ($0) => { let idstr = UTF8ToString($0); let element = document.getElementById(idstr); return element.height; }
};
...
function run() {
  ...
  function doRun() {
    ...
    var noInitialRun = Module['noInitialRun'] || true;legacyModuleProp('noInitialRun', 'noInitialRun');
